...
STARTPOS = [v_center,                             # Sun
            ...
            v_center + np.array([0, 15.24844e7]), # Moon of Earth
...
RADIUS = [695700.0, 6378.0, 1737.0, 3396.0, 69911.0, 60268.0]
TRACE_LENGTH = [100, 50, 10, 50, 150, 150]
TRACE_TIME = [ 24*3600*365*5, 24*3600*365,24*3600*182, 24*3600*687, 24*3600*365*11.8, 24*3600*365*29.5]
